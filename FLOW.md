...
- 🔄 **3.3 五个头**：M1/M2/M3(GAT+贪心)/M4/M5。
  ...
  - **✅ M5 探索完成**（PCMCI+ 因果时滞）：降采样+剪枝后 26.8 分钟跑完；发现藻类自相关主导、气象直接驱动弱（经水温中介）。见架构蓝图 §3.7。**五头全部有探索实证**。
