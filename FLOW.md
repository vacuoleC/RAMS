...
- **下一步**：M1 精度优先 + 免费 M2/M4 + 校准优于单任务 → 生产可采纳 K 方向 ts_freeze（20+10，冻结 backbone）；覆盖达标 80% 仍保留多任务增量（w=1/3/2）或 ts_freeze 加事后共形/更长 Stage2；若要再压点精度走数据量/评估协议方向或探多任务权重（降 w_m2/w_m4）
